 ...
 */
export class FilterGraphSegment implements Disposable {
  private native: NativeFilterGraphSegment;
   ...
   */
  apply(inputs: FilterInOut, outputs: FilterInOut, flags = 0): number {
